...
CREATE TABLE ExemplaireFilm(
    codeExemplaire NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Location(
    ...
    dateMax DATE,
    codeExemplaire NUMBER NOT NULL,
...
--Trigger pour l'ajout d'ExemplaireFilm entre 1 et 100--
CREATE OR REPLACE TRIGGER trg_ajouter_exemplaire
AFTER INSERT ON Film
FOR EACH ROW
DECLARE
    random_number NUMBER;
    num_exemplaires NUMBER;
BEGIN
    random_number := TRUNC(DBMS_RANDOM.VALUE(1, 101));

    num_exemplaires := random_number;

    FOR i IN 1..num_exemplaires
    LOOP
        INSERT INTO ExemplaireFilm(idFilm)
        VALUES(:NEW.idFilm);
    END LOOP;
END;
/
